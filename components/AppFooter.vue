<template>
  <footer class="bg-white shadow-md sticky top-[100vh]">
    <div
      class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4"
    >
      <div class="text-sm flex justify-start items-start">
        © {{ year }}
        <div class="flex justify-start items-start pl-1 space-x-1">
          <svg
      ...
      >
        <li>
          <a
            href="https://github.com/gsusgit/nuxt-app"
            target="_blank"
